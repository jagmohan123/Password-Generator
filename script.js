...
function calculateStringLength() {
    ...
    if (hasUpperCase && hasLowerCase && (hasNumbers || haSymbols) && passwordLength >= 8) {
        setinticater('#0f0')
    }
    else if ((hasLowerCase || hasUpperCase) && (hasNumbers || haSymbols) && passwordLength >= 6) {
        setinticater('#ff0')
    }
    else {
        setinticater('#f00')
...
console.log("i  am colling ")
    ...
    // remove old password 
    password = "";
    // lets put the stuff mention y checkbox
    // if (upperCase.checked) {
